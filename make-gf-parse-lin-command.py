...
def serialize_command(lang_in, lang_out, cat, line):
	print 'p -lang={:} -cat={:} "{:}" | l -lang={:} -treebank -all'.format(lang_in, cat, line, lang_out)
...
parser.add_argument('-l', '--lang-in',
	...
	default='Eng',
	help='3-letter language code, e.g. Ger (defaults to Eng)')
...
parser.add_argument('-c', '--cat',
	...
	default='Phrase',
	help='start category (defaults to Phrase)')
